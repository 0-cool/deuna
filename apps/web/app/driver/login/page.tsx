...
export default async function DriverLoginPage({
  ...
  return (
    <section className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-4">
      ...
      <h1 className="mt-3 font-display text-2xl text-paper">Inicia sesión como driver</h1>
      ...
      <p className="mt-6 text-xs text-paper/40">
        Demo: usa el correo de cualquier driver del seed (ej.{" "}
        <code>carlos-perez@drivers.deuna.do</code>) con la contraseña{" "}
        <code>deuna123</code>.
      </p>
    </section>
  );
